...
class Pokemon:
    ...
    #Pokemon bilgilendirmesi
    def __info__(self,ctx, pokemon_trainer):
        if [self,ctx,pokemon_trainer] in Pokemon.pokemons:
            pok = Pokemon.pokemons[self,ctx.author.name]
...
class Wizard(Pokemon):
    ...
    def feed(self):
        return super().feed(feed_inval=10)
...
a = datetime(2025,2, 16)
print(a)
 
# Initializing constructor
# with time parameters as well
a = datetime(2025,2,16, 6, 2, 32, 5456)
print(a)
